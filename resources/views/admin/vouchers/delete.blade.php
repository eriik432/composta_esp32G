...
@section('content')
    <div id="layoutSidenav_content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Gestión de Comprobantes Rechazados</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-white">
                <h6 class="m-0 font-weight-bold text-primary">Lista de Comprobantes Rechazados</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="planesTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            @forelse ($vouchers as $voucher)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('vouchers.activate', $voucher->id) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('PUT')
