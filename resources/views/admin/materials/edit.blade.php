...
<div id="layoutSidenav_content" class="p-4 bg-gray-50 min-h-screen">
    ...
    <div class="mb-4">
        <h1 class="text-2xl font-bold text-gray-800 flex items-center">
            <i class="fas fa-edit text-green-600 mr-2"></i> Editar Material
        </h1>
    </div>
        ...
        <form action="{{ route('materials.update', $material->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="file" name="image" id="image"
                       ...
                       accept="image/*">
                @if($material->image)
                    <p class="mt-2 text-sm text-gray-500">Imagen actual: <strong>{{ $material->image }}</strong></p>
                    <img src="{{ asset( $material->image) }}" alt="Imagen Material" class="mt-2 w-32 h-32 object-cover rounded">
                @endif
            </div>
